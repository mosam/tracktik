<?php 
/**
 * This class is used for electronic controler item which includes in extras item of electronic.
 */ 
include_once('app/Controllers/ElectronicItem.php');
include_once('app/Controllers/Electronic.php');

class Controler extends Electronic
{ 
	 ...
	 /**
	 * Constructor
	 * @param price which is price of the controller  
